...
def fetch(subjects, dataset, keypoints, action_filter=None, stride=1, parse_3d_poses=True, image_names=None):
    out_poses_3d = []
    out_poses_2d = []
    out_actions = []
    out_image_names = []
    ...
    return out_poses_3d, out_poses_2d, out_actions, out_image_names
